...
- **To a human**, the default slip is *under*-modeling — writing for a literal
  token-absorber: too blunt, missing what they will infer, ignoring what is better
  left unsaid.
- **To an AI executor**, the default slip is the opposite, *over*-specifying —
...
2. **Climb the ladder** (this is k-level reasoning; do as many layers as the stakes
   ...
   - **L2** — what they *infer* about your intent, the situation, or the task from
     *how* it is written and from what you leave out.
...
you are authoring), keep the ladder but change *what* you model:
...
- Weak: "Can you confirm by Friday? We're waiting on you." — reads as chasing someone you
  can't actually rush.
- Strong: frame Friday as *your* downstream constraint, give an easy path to respond, and
