...
call s:hi('TabLine',      '#69676c', '#2c2c2c', '')
call s:hi('TabLineSel',   '#f7f1ff', '#222222', 'bold')
call s:hi('TabLineFill',  '#69676c', '#2c2c2c', '')
call s:hi('Folded',       '#69676c', '#2c2c2c', 'italic')
call s:hi('FoldColumn',   '#69676c', '#222222', '')
call s:hi('SignColumn',   '#69676c', '#222222', '')
call s:hi('ColorColumn',  '',        '#2c2c2c', '')
call s:hi('WildMenu',     '#222222', '#5ad4e6', 'bold')
call s:hi('Title',        '#fd9353', '',        'bold')
call s:hi('Error',        '#f7f1ff', '#fc618d', 'bold')
