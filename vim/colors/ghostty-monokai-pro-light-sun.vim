...
call s:hi('TabLine',      '#72696d', '#eee4dc', '')
call s:hi('TabLineSel',   '#2c232e', '#f8efe7', 'bold')
call s:hi('TabLineFill',  '#72696d', '#eee4dc', '')
call s:hi('Folded',       '#72696d', '#eee4dc', 'italic')
call s:hi('FoldColumn',   '#a59c9c', '#f8efe7', '')
call s:hi('SignColumn',   '#a59c9c', '#f8efe7', '')
call s:hi('ColorColumn',  '',        '#eee4dc', '')
call s:hi('WildMenu',     '#f8efe7', '#2473b6', 'bold')
call s:hi('Title',        '#d4572b', '',        'bold')
call s:hi('Error',        '#f8efe7', '#ce4770', 'bold')
