...
- **语言要求**：使用中文，但是为了保持理解一致性，对于专有技术术语或专有名词，仍用英文表达
...
遵循[中文文案排版指北](https://github.com/sparanoid/chinese-copywriting-guidelines)的所有内容：
...
参照 [markdownlint](https://github.com/DavidAnson/markdownlint) 的编号与规则，特别注意需要遵守一下这些规则：
